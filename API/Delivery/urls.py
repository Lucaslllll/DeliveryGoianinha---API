...
router.register('api/codimentos_restaurante', api.CodimentosRestauranteViewSet, 'codimentos')
...
urlpatterns += [
	...
	path('api/pegar_codimentos/<str:restaurante_slug>', api.PegarCodimentosRestaurante.as_view(), name='pegar_codimentos'),
